...
def test_frontend_has_one_vite_entry_and_bounded_growth_components() -> None:
    ...
    assert line_count(ROOT.parent / "frontend" / "src" / "features" / "growth" / "ProductGrowthHub.tsx") < 900
    assert line_count(ROOT.parent / "frontend" / "src" / "features" / "growth" / "ClubWorkspace.tsx") < 900
