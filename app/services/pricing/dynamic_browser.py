...
from app.services.common.outbound_http import safe_get, validate_url


BROWSER_PATH = Path(__file__).resolve().parents[3] / "data" / "ms-playwright"
...
def render_dynamic_html(url: str, user_agent: str, wait_ms: int = 3500) -> str:
    ...
    from app.services.pricing.retailer_offers import RETAILERS
