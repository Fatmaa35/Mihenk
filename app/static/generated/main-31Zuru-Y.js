...
function Cv() {
  ...
  xa.useEffect(() => {
    ...
    }, import("./app-shell-COBGUcX3.js").then(({ initializeAppShell: ne }) => ne());
  }, []);
  async function U() {
    if (r) {
      h(!0), E("");
...
function vh() {
  ...
  const c = async () => {
    if (!(!r || i)) {
      i = !0;
      try {
        const { BentoReadingDashboard: R } = await import("./BentoReadingDashboard-BqL_j_yR.js");
  ...
  const A = async () => {
    if (!(!o || h)) {
      h = !0;
      try {
        const { ProductGrowthHub: R } = await import("./ProductGrowthHub-BGwyihLd.js");
